...
# data = pd.read_csv("ihlp_multi_inputs/request_responsible_subject_description_label.csv", names=["id", "subject", "description", "label"])
data = pd.read_csv("backend/pipeline/data/output/4_data_merged/output_merged.csv", names=["id", "subject", "description", "responsible_last"])
data = data.rename(columns={'responsible_last': 'label'})
